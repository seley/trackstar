...
class Issue extends CActiveRecord
{
	...
	public function search()
	{
        ...
        public function getStatusText(){
            $statusOptins = $this->getStatusOptions();
            return (isset($statusOptins[$this->status_id]))?
                $statusOptins[$this->status_id]:
                "unknow Status({$this->status_id})";
        }
